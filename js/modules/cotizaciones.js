    ...
    <div data-modal="cotizador" style="position:fixed;top:0;left:0;width:100%;height:100%;background:rgba(0,0,0,0.5);z-index:9999;display:flex;align-items:flex-start;justify-content:center;overflow-y:auto;padding:20px;">
      <div style="background:white;border-radius:12px;width:100%;max-width:720px;padding:28px;margin:auto;">
        ...
        <div style="display:grid;grid-template-columns:1fr auto auto;gap:10px;align-items:end;margin-bottom:12px;">
          <select id="cotProductoSel" style="padding:9px;border:1px solid #d1d5db;border-radius:6px;">
        ...
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px;">
          <strong>Total: <span id="cotTotal" style="color:#1e40af;font-size:18px;">$0.00</span></strong>
        </div>
...
function imprimirCotizacion(id) {
    ...
    <div style="text-align:right;margin-top:16px;font-size:20px;font-weight:bold;">TOTAL: $${Number(c.total).toFixed(2)}</div>
