...
function abrirHistorialPuntosCliente(clienteId) {
    ...
    const rows = historial.map(h => {
        ...
        return `<tr>
          <td style="padding:8px;">${(window.parseFechaMX ? window.parseFechaMX(h.fecha) : new Date(h.fecha)).toLocaleDateString('es-MX', { day: '2-digit', month: '2-digit', year: 'numeric', timeZone: 'America/Mexico_City'})}</td>
